## novatel_gps_driver (lyrical) - 4.3.1-1

The packages in the `novatel_gps_driver` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical novatel_gps_driver` on `Mon, 24 Aug 2026 00:04:40 -0000`
...
## novatel_gps_driver (kilted) - 4.3.1-1

The packages in the `novatel_gps_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted novatel_gps_driver` on `Mon, 24 Aug 2026 00:01:59 -0000`
...
## novatel_gps_driver (jazzy) - 4.3.1-1

The packages in the `novatel_gps_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy novatel_gps_driver` on `Mon, 24 Aug 2026 00:00:01 -0000`
...
## novatel_gps_driver (humble) - 4.3.1-1

The packages in the `novatel_gps_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble novatel_gps_driver` on `Sun, 23 Aug 2026 23:58:01 -0000`
...
## novatel_gps_driver (rolling) - 5.0.0-1

The packages in the `novatel_gps_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling novatel_gps_driver` on `Sun, 23 Aug 2026 23:54:27 -0000`
...
## novatel_gps_driver (rolling) - 4.3.0-1

The packages in the `novatel_gps_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling novatel_gps_driver` on `Wed, 03 Jun 2026 21:01:47 -0000`
...
## novatel_gps_driver (lyrical) - 4.3.0-1

The packages in the `novatel_gps_driver` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical novatel_gps_driver` on `Wed, 03 Jun 2026 21:00:21 -0000`
...
## novatel_gps_driver (kilted) - 4.3.0-1

The packages in the `novatel_gps_driver` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --edit --rosdistro kilted novatel_gps_driver` on `Wed, 03 Jun 2026 20:59:02 -0000`
...
## novatel_gps_driver (jazzy) - 4.3.0-1

The packages in the `novatel_gps_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy novatel_gps_driver` on `Wed, 03 Jun 2026 20:57:14 -0000`
...
## novatel_gps_driver (humble) - 4.3.0-1

The packages in the `novatel_gps_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble novatel_gps_driver` on `Wed, 03 Jun 2026 20:54:36 -0000`
...
## novatel_gps_driver (rolling) - 4.2.1-1

The packages in the `novatel_gps_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling novatel_gps_driver` on `Tue, 02 Jun 2026 22:19:43 -0000`
...
## novatel_gps_driver (lyrical) - 4.2.1-1

The packages in the `novatel_gps_driver` repository were released into the `lyrical` distro by running `/usr/bin/bloom-release --edit --rosdistro lyrical novatel_gps_driver` on `Tue, 02 Jun 2026 22:17:34 -0000`
...
## novatel_gps_driver (humble) - 4.2.1-1

The packages in the `novatel_gps_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble novatel_gps_driver` on `Thu, 24 Apr 2025 20:13:26 -0000`
...
## novatel_gps_driver (rolling) - 4.2.0-1

The packages in the `novatel_gps_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling novatel_gps_driver` on `Fri, 08 Nov 2024 16:36:36 -0000`
...
The packages in the `novatel_gps_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble novatel_gps_driver` on `Fri, 08 Nov 2024 16:26:32 -0000`
...
## novatel_gps_driver (rolling) - 4.1.3-1

The packages in the `novatel_gps_driver` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --edit --rosdistro rolling novatel_gps_driver` on `Fri, 11 Oct 2024 22:18:18 -0000`
...
## novatel_gps_driver (jazzy) - 4.1.3-1

The packages in the `novatel_gps_driver` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --edit --rosdistro jazzy novatel_gps_driver` on `Fri, 11 Oct 2024 22:15:52 -0000`
...
## novatel_gps_driver (iron) - 4.1.3-1

The packages in the `novatel_gps_driver` repository were released into the `iron` distro by running `/usr/bin/bloom-release --edit --rosdistro iron novatel_gps_driver` on `Fri, 11 Oct 2024 22:13:03 -0000`
...
## novatel_gps_driver (humble) - 4.1.3-1

The packages in the `novatel_gps_driver` repository were released into the `humble` distro by running `/usr/bin/bloom-release --edit --rosdistro humble novatel_gps_driver` on `Fri, 11 Oct 2024 22:10:27 -0000`
